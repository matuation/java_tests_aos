...
//        String.format("Hello, %s %s %s!", "Alex", "Egorov"); -> "Hello, Alex !";
    ...
    public static final String getRandomHobby2() {
        String randomHobby2 = "";
        String selectedHobby = chosenHobby;
        String[] hobbies = {"Sports", "Reading", "Music"};
    ...
    public static String getRandomCity() {
        ...
        if(chosenState.equals("NCR")){
            randomCity = getRandomItemFromStringArray(citiesNCR);}
        else if(chosenState.equals("Uttar Pradesh")){
            randomCity = getRandomItemFromStringArray(citiesUttarPradesh);}
        else if(chosenState.equals("Haryana")){
            randomCity = getRandomItemFromStringArray(citiesHaryana);}
        else {
            randomCity = getRandomItemFromStringArray(citiesRajasthan); }
        return randomCity;
    }
}
